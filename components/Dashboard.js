...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { name, email, username, upi, bio } = formData;
    if (!name.trim() || !email.trim() || !username.trim() || !upi.trim() || !bio.trim()) {
  ...
  return (
    <div className='flex w-full items-center justify-center h-[100vh]'>
      <form className="form1" onSubmit={handleSubmit}>
        <div className="self-center text-center text-[color:var(--font-color)] font-black text-xl mb-[15px]">
          Welcome,<br />
          <span className='text-[color:var(--font-color-sub)] font-semibold text-[17px]'>to your Dashboard</span>
        </div>

        <input className="input1" name="name" placeholder="Your Name" type="text" value={formData.name} onChange={handleChange} required />
        <input className="input1" name="email" placeholder="Your Email" type="email" value={formData.email} readOnly required />
        <input className="input1" name="username" placeholder="Your Username" type="text" value={formData.username} onChange={handleChange} required />
        <input className="input1" name="profilePicture" placeholder="Your Profile Picture URL" type="text" value={formData.profilePicture} onChange={handleChange} required />
        <input
          className="input1"
          name="bio"
          ...
          required
        />
        <input className="input1" name="upi" placeholder="Your UPI ID" type="text" value={formData.upi} onChange={handleChange} required />
